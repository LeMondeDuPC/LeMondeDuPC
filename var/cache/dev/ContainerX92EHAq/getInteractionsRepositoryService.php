...
// Returns the private 'App\Repository\InteractionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InteractionsRepository.php';

return $this->privates['App\\Repository\\InteractionsRepository'] = new \App\Repository\InteractionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
