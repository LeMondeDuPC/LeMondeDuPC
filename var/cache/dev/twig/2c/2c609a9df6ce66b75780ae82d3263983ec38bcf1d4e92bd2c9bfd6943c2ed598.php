...
/* user/show.html.twig */
class __TwigTemplate_9e92131af7235db369170208f193e7e190a99d82e24f338831765a5bec92c973 extends \Twig\Template
{
    private $source;
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        // line 10
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 10, $this->source); })()), "createdAt", [], "any", false, false, false, 10), "d/m/Y"), "html", null, true);
        echo "</time>
            </div>
        </header>
        ...
        <div>
            <p>
                ";
        // line 17
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 17, $this->source); })()), "description", [], "any", false, false, false, 17))) {
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 17, $this->source); })()), "description", [], "any", false, false, false, 17), "html", null, true);
        }
        // line 18
        echo "            </p>
        </div>
        ...
        echo " : ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 22, $this->source); })()), "lastConnection", [], "any", false, false, false, 22), "d/m/Y"), "html", null, true);
        echo "</li>
            </ul>
        </footer>
    </article>
";
    ...
    {
        return array (  104 => 22,  98 => 18,  94 => 17,  88 => 14,  84 => 13,  78 => 10,  70 => 7,  65 => 4,  56 => 3,  34 => 1,);
    }
