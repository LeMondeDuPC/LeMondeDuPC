...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(($this->privates['cocur_slugify.twig.slugify'] ?? $this->getCocurSlugify_Twig_SlugifyService()));
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lNy310otU-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Q9KPvgmxZp', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EivWQr7CrC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CY-Vl5ZlOe', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zfXkEaTk5M', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8r5cbvHt35', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }

    /**
     * Gets the private 'cocur_slugify' shared service.
     *
     * @return \Cocur\Slugify\Slugify
     */
    protected function getCocurSlugifyService()
    {
        return $this->privates['cocur_slugify'] = new \Cocur\Slugify\Slugify([]);
    }

    /**
     * Gets the private 'cocur_slugify.twig.slugify' shared service.
     *
     * @return \Cocur\Slugify\Bridge\Twig\SlugifyExtension
     */
    protected function getCocurSlugify_Twig_SlugifyService()
    {
        return $this->privates['cocur_slugify.twig.slugify'] = new \Cocur\Slugify\Bridge\Twig\SlugifyExtension(($this->privates['cocur_slugify'] ?? ($this->privates['cocur_slugify'] = new \Cocur\Slugify\Slugify([]))));
    }
