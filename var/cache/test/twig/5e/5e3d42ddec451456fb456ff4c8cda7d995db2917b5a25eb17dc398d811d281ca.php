...
class __TwigTemplate_d0d8e25a8c03624dc9bc08891c1084325904b977717f7ea122d223f3a6ecfc58 extends Twig_Template
{
    private $source;
    ...
    {% for post in posts %}
        <article class=\"post\">
            ...
            <a href=\"{{ path('blog_post', {'id': post.p_id, 'slug': post.p_title|slugify}) }}\" class=\"image featured\">
                <img src=\"{{ asset('assets/images/pic01.jpg') }}\" alt=\"{{ 'Picture of the post'|trans }}\"/>
            </a>
            <div>
                <p>
                    {{ post.p_description }}
            ...
            <footer>
                <ul class=\"actions\">
                    <li><a href=\"{{ path('blog_post', {'id': post.p_id, 'slug': post.p_title|slugify}) }}\" class=\"button large\">{{ 'Continue reading'|trans }}</a></li>
                </ul>
                <ul class=\"stats\">
