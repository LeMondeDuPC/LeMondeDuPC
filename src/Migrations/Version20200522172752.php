 ...
 */
final class Version20200522172752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE uploads (id INT AUTO_INCREMENT NOT NULL, posts_id INT DEFAULT NULL, file_name VARCHAR(255) NOT NULL, INDEX IDX_96117F18D5E258C5 (posts_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
